...
namespace XRMultiplayer
{
    ...
    public class XRINetworkGameManager : NetworkBehaviour
    {
        ...
        public void StartServer()
        {
            ...
            Debug.Log(serverStarted ? "Server started successfully on 192.168.0.1:7777" : "Failed to start server.");
        }
        ...
        public void StartClient()
        {
            ...
            Debug.Log("Client is attempting to connect to server at 192.168.0.1:7777.");
        }
        /// <summary>
